...
% function opt_wrap
% Input: parameters and data structure
% Output: least squares cost, model residual, and jacovian
% Uses: model_wrap.m integrating optimized parameters with all parameters
% Description: This function calculates the finite difference Jacobian. The
% function only takes parameters to be estimated
