...
if opt_flag == 0
    sgtitle(strcat(pt_id,'_nominal'),'fontsize',fs,'FontWeight','bold','Interpreter', 'none')
elseif opt_flag == 1
    sgtitle(strcat(pt_id,'_weighted_optimization'),'fontsize',fs,'FontWeight','bold','Interpreter', 'none')
end
